  ...
  tabsetPanel(id="panel1",
    tabPanel(title="Hierarchy",
      div(id="div_create",
        ...
        fluidRow(
          column(4, align="center", radioButtons("tot_is_included", label="Overall Total available?", choices=c("yes","no"), inline=TRUE)),
          column(4, align="center", radioButtons("as_df", label="Result as data.frame?", choices=c("yes", "no"), inline=TRUE)),
        ...
        uiOutput("spec"),
        fluidRow(id="row_create_btn",
          column(12, align="center", actionButton("createHier", "createHierarchy", class="btn-success"))
        )
      ),
      fluidRow(
      ...
      shinyjs::hidden(div(id="div_modify",
        fluidRow(
          column(12, align="left",h2("Modify the Hierarchy2"))
        ),
        fluidRow(
          column(12, align="center", actionButton("reset_bt2n", "Reset hierarchy", class="btn-danger"))
        )
      ))
    ),
    tabPanel(title="Code",
