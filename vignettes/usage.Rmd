...
We also note that there is another way to specify the inputs in `hier_compute()`. Setting argument `method = "list"` allows to create a hierarchy from a given named list. In such a list, the name of a list element is interpreted as parent to all codes or labels listed for this element. A simple example is shown below:
...
d <- hier_compute(inp = yae_ll, tot_lev = "Total", method = "list"); d
```
